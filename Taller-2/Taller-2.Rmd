...
## 8. Escriba el estimador de Nadarya–Watson para la funci´on media en t, es decir, ˆμ(t). Note que todos los datos discretizados son utilizados en la estimaci´on de la funci´on media.
